...
class TablaPermisosSeeder extends Seeder
{
    ...
    public function run()
    {
        $permisos = collect([
            ...
            //tabla vistas;
            ['id' => 13, 'name' => 'ver-menu', 'guard_name' => 'web'],
            ['id' => 14, 'name' => 'ver-menu-roles', 'guard_name' => 'web'],
            ['id' => 15, 'name' => 'ver-menu-usuarios', 'guard_name' => 'web'],
            ['id' => 16, 'name' => 'ver-menu-alumnosa', 'guard_name' => 'web'],
            ['id' => 17, 'name' => 'ver-menu-periodos', 'guard_name' => 'web'],
            ['id' => 18, 'name' => 'ver-menu-graficas', 'guard_name' => 'web'],
            //tabla periodo
            ['id' => 19, 'name' => 'ver-periodo', 'guard_name' => 'web'],
            ['id' => 20, 'name' => 'crear-periodo', 'guard_name' => 'web'],
            ['id' => 21, 'name' => 'editar-periodo', 'guard_name' => 'web'],
            ['id' => 22, 'name' => 'borrar-periodo', 'guard_name' => 'web'],
            //tabla panel de control
            ['id' => 23, 'name' => 'ver-card', 'guard_name' => 'web'],
