                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped mt-2">
                                <thead style="background-color: #6777ef;">
                                    ...
                                    <th style="color: #fff;" class="col-sm-1">Cursos</th>
                                    <th style="color: #fff;" class="col-sm-1">Alumnos</th>
                                    <th style="color: #fff;" class="col-sm-1">Clases</th>
                                    <th style="color: #fff;" class="col-sm-1">Descripción</th>
                                    <th style="color: #fff;" class="col-sm-1">Acciones</th>
                                </thead>
                                <tbody>
                                    @foreach ($cursos as $curso)
                                    @can('ver-usuario')
